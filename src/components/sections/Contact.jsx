      ...
      <RevealOnScroll>
        <div className="px-4 w-full min-w-[300px] md:w-[500px] sm:w-2/3 p-6">
          ...
          <div className="flex justify-center space-x-6 mt-6 text-gray-300">
            <a href="mailto:rajakesavamadhavan.m@gmail.com" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.linkedin.com/in/raja-kesava-madhavan-m-52467a294/" target="_blank" rel="noopener noreferrer">
              <FaLinkedin className="text-blue-400 text-2xl hover:scale-110 transition-transform" />
            </a>
            <a href="https://github.com/RKM2307" target="_blank" rel="noopener noreferrer">
